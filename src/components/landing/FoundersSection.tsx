        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <article className="bg-white rounded-2xl shadow-card hover:shadow-card-hover transition-shadow duration-300 p-8 flex flex-col gap-5 border-l-4 border-brand-purple">
              <div className="w-[120px] h-[120px] rounded-full overflow-hidden border-4 border-brand-purple/20 shadow-brand-glow-sm flex-shrink-0">
                <img
                  src="/lovable-uploads/flavio-horita.jpg"
                  alt="Flávio Horita — Co-fundador da Nexxu"
