...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "NexxuLab | Consultoria em IA para PME" },
      { property: "og:title", content: "NexxuLab | Consultoria em IA para PME" },
      { name: "twitter:title", content: "NexxuLab | Consultoria em IA para PME" },
